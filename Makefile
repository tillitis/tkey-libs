...
# Common C functions
LIBOBJS=libcommon/assert.o libcommon/led.o libcommon/lib.o libcommon/proto.o libcommon/qemu_debug.o
libcommon/libcommon.a: $(LIBOBJS)
	llvm-ar -qc $@ $(LIBOBJS)
$(LIBOBJS): include/types.h include/tk1_mem.h include/lib.h include/proto.h include/led.h include/assert.h include/qemu_debug.h
